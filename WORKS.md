...
<details>
<summary>Click to expand to just some text that works</summary>
I'm some text.
</details>

Here's a second infix...

<details>
<summary>Click to expand to some code (specifically Go, should have syntax highlighting)</summary>
<pre>
fmt.Println("Some other go code")
</pre>
</details>

Here's a third infix...

<details>
<summary>Click to expand to some code (unspecified which language)</summary>
<pre>
fmt.Println("Some other go code without a language specifier")
</pre>
</details>
